...
public class AddPatient extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        allPatientsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Id", "Name", "Age", "Community", "House"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!(util.isNotNullAndEmpty(nameTxt.getText()) && util.isAlphabetic(nameTxt.getText())))
            ...
            if(!(util.isPatientIdUnique(patientIdTxt.getText(),patientList)))
                message = "This patientid already exists. Please enter a unique patient id."; 
            if(!"".equals(message)){
    ...
    private void populateTable() {
        ...
        for(Patient patient: sys.getPatientDirectory().getList()){
          ...
          row[3] = patient.getHouse().getCommunity().getName();
          row[4] = patient.getHouse().getHouseNumber();
